...
<!-- 								</td> -->
				...
				<div id="pageList">
					...
					<input type="button" onclick="location.href='AdminAccountDetail?pageNum=${pageNum - 1}&project_code=${param.project_code}'" <c:if test="${pageNum <= 1}">disabled</c:if>>
					...
					<input type="button" onclick="location.href='AdminAccountDetail?pageNum=${pageNum + 1}&project_code=${param.project_code}'" <c:if test="${pageNum >= pageInfo.maxPage}">disabled</c:if>>
				</div>
			</article>
		</section>
	</div>
