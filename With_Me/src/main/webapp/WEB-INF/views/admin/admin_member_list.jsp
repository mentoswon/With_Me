					...
					<table border="1">
						...
						<c:forEach var="member" items="${memberList}">
							<tr align="center">
								...
								<td>
									<input type="button" value="후원내역" onclick="location.href='AdminMemberSponsorshipDetail?mem_email=${member.mem_email}'">
									<input type="button" value="구매내역" onclick="location.href='AdminMemberPurchaseHistory?mem_email=${member.mem_email}'">
								</td>
							</tr>
						</c:forEach>
