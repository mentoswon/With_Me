	...
	<main>
		<section id="articleForm">
			...
			<section id="articleContentArea">
				 ...
				 <b>2. 기부하기 위한 펀딩인가요?</b>
				 <a>
				 펀딩을 통해 선한 영향력을 전하고 싶은 따뜻한 마음에는 공감합니다. 하지만 위드미은 신규 창작이나 제작이 목적인 펀딩만 진행하실 수 있어요. 
				 따라서 위드미으로 모은 금액의 일부나 전체를 제 3자에게 전달하거나, 물품을 구입하여 전달하기 위한 프로젝트는 진행하실 수 없습니다.
				 </a>
				 <b>3. 홍보 만을 위한 펀딩인가요?</b>
				 <a>
				 위드미의 프로젝트는 구체적인 목표, 분명한 완료 기준, 예상 결과물이 있어야 합니다. 그래서 브랜드 홍보나 인식 개선, 혹은 캠페인 만을 위한 프로젝트는 진행할 수 없어요. 목표가 추상적이기 때문에 목표를 달성했는지도 분명하게 알기 어렵기 때문이에요. 
