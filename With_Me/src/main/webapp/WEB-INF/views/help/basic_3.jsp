	...
	<main>
		<section id="articleForm">
			...
			<section id="articleContentArea">
				 ...
				 <ul>
					 <li>ㆍ위드미에서의 후원은 아직 실현되지 않은 프로젝트가 실현될 수 있도록 제작비를 후원하는 과정으로, 익숙한 인터넷 쇼핑과는 다릅니다. 기존의 상품 또는 용역을 거래의 대상으로 하는 매매와는 차이가 있어 전자상거래법상 청약철회 등의 규정이 적용되지 않습니다.</li>
					 <li>ㆍ위드미에서 진행되는 프로젝트를 완수할 책임과 권리는 해당 프로젝트를 진행한 창작자에게 있습니다.</li>
				 </ul>
			</section>
